...
# 2) Strengthen only Dean's existing CCv2 post_history_instructions.
...
# 3) Narrow migration for already-saved copies of the bundled Dean card.
...
# 4) Regression coverage for the narrow bundled-card migration.
test_path = Path('tests/legacyCharacterMigration.test.ts')
...
assert insert_anchor in test, 'Legacy test insertion anchor not found'
