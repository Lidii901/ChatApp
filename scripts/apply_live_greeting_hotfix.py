...
old_push = "  push:\n    branches: [ui-mechat-rework]\n"
assert old_push in text
text = text.replace(old_push, "  push:\n    branches: [main]\n", 1)
marker = "      - name: Imitate Me knowledge-boundary regression tests\n        run: npx tsx tests/imitateKnowledge.test.ts\n"
